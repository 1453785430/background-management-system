...
import com.web.component.HandlerMapping;
import com.web.component.InvocationHandler;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //扫描controller包
        String controllerUrl = "com.web.controller";
...
//            } else if (AnnotationUtil.hasAnnotation(method, com.web.annotation.HttpServlet.class)) {
...
//            }
            //方便使用 所有controller方法都默认传两个参数 request response
