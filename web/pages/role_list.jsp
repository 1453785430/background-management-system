                                ...
                                <form class="pull-right search-bar" method="get" action="#!" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <input type="hidden" name="search_field" id="search-field" value="roleName">
...
<script type="text/javascript">
    ...
    function addRole() {
        ...
        document.getElementById("exampleModalLabel").innerText="新增角色";
    }
    ...
    function editRole(id) {
        type = 2;
        document.getElementById("roleForm").reset();//重置表单
        document.getElementById("exampleModalLabel").innerText="修改角色";
        $.ajax({
