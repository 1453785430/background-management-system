                            ...
                            <li
                                    <c:if test="${not empty menu.list}">
                                        class="nav-item nav-item-has-subnav <c:if
                                            test="${menu.id==3}"> active open </c:if> "
                                    </c:if>
                            ><a
                                ...
                                <ul class="nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li <c:if test="${menuItem.id==3}">class="active" </c:if>>
                                                <a<c:if test="${not empty menuItem.href}">
                                                    href="${ctx}${menuItem.href}" </c:if> >${menuItem.title}
                                                </a>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="#!" business="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <input type="hidden" name="search_field" id="search-field" value="businesssname">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="#!"
                                       data-toggle="modal" data-target="#editBusiness"
                                       onclick="addBusiness()"
                                    ><i class="mdi mdi-plus"></i> 新增</a>
                                    <a class="btn btn-success m-r-5" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                                    <a class="btn btn-danger" onclick="enableBusiness()" href="#!"><i class="mdi mdi-window-close"></i> 删除</a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="business" items="${businessList}" varStatus="status">
                                            <tr>
                                                <td>
                                                    <label class="lyear-checkbox checkbox-primary">
                                                        <input type="checkbox" name="ids[]" value="${business.id}"><span></span>
                                                    </label>
                                                </td>
                                                <td>${status.index+1}</td>
                                                <td>${business.shopName}</td>
                                                <td>${business.tel}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a data-toggle="modal" data-target="#editBusiness"
                                    ...
                                    <form id="businessForm">
                                        <div class="modal fade" id="editBusiness" tabindex="-1" business="dialog"
                                             aria-labelledby="exampleModalLabel">
                                            <div class="modal-dialog" business="document">
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="shopName" class="control-label">商家名:</label>
...
<script type="text/javascript">
    ...
    function addBusiness() {
        type = 1;
        document.getElementById("businessForm").reset();//重置表单
        document.getElementById("exampleModalLabel").innerText="添加商家";
    }
    ...
    function editBusiness(id) {
        type = 2;
        document.getElementById("businessForm").reset();//重置表单
        document.getElementById("exampleModalLabel").innerText="修改商家";
        $.ajax({
    ...
    function saveBusiness() {
        if (checkBusiness()) {
            ...
            $.ajax({
                url: "${ctx}/api/business/editBusiness",
                type: "post",
                dataType: "json",
                data: {
                    id: id,
