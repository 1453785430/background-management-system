                            ...
                            <li
                                    <c:if test="${not empty menu.list}">
                                        class="nav-item nav-item-has-subnav <c:if
                                            test="${menu.id==2}"> active open </c:if> "
                                    </c:if>
                            ><a
                                ...
                                <ul class="nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li <c:if test="${menuItem.id==2}">class="active" </c:if>>
                                                <a<c:if test="${not empty menuItem.href}">
                                                    href="${ctx}${menuItem.href}" </c:if> >${menuItem.title}</a></li>
                                        </c:forEach>
                                    </c:if>
                                </ul>
                            </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="#!" user="form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form id="userForm">
                                        <div class="modal fade" id="editUser" tabindex="-1" user="dialog"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="sex" class="control-label">性别(1:男 2:女):</label>
